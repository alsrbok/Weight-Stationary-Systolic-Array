...
HD_PWD='C:/Users/VLSI/Desktop/Vivado Code/NPU_systolic_array/NPU_systolic_array.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log systolic_array_2by2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source systolic_array_2by2.tcl
